    ...
    return <div className="content content-margined">
      ...
      <ul className="form-container">
        ...
        <li>
          ...
          <input type="text" name="countInStock" value={countInStock || '0'} id="countInStock" onChange={(e) => setCountInStock(e.target.value)}>
          </input>
        </li>
        <li>
          ...
          {products.map((product) => (
            <tr key={product._id}>
              ...
              <td>
                ...
                <button
                  className="button" onClick={() => deteteHandler(product)} >
                  Delete
                </button>
              </td>
            </tr>
